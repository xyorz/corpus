...
SECRET_KEY = '1comcndg*fo62g+y2exudzc0a3%3=3nytm%hodp_jglz8rn+q7'
...
MIDDLEWARE = [
    ...
    # 'apps.dmdb.LoginRequiredMiddleware.LoginRequiredMiddleware',
    # 'apps.dmdb.EncryptMiddleware.EncryptMiddleware',
